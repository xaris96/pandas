...
class WebSocketReader:
    def __init__(
        ...
        self._frame_payload: bytes | bytearray = b""
        ...
        self._compressed: bool | None = None
    ...
    def parse_frame(
        self, buf: bytes
    ) -> list[tuple[bool, int | None, bytes | bytearray, bool | None]]:
        """Return the next frame from the socket."""
        frames: list[
            tuple[bool, int | None, bytes | bytearray, bool | None]
        ] = []
        if self._tail:
