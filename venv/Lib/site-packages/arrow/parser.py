...
class DateTimeParser:
    ...
    def parse_iso(
        ...
        if has_time:
            ...
            time_components: Match[str] | None = self._TIME_RE.match(time_parts[0])
    ...
    def _parse_token(
        ...
        value: str | bytes | SupportsInt | bytearray,
        parts: _Parts,
    ) -> None:
        ...  # pragma: no cover
    ...
    def _parse_token(
        self,
        token: Literal["X"],
        value: str | bytes | SupportsFloat | bytearray,
        parts: _Parts,
    ) -> None:
        ...  # pragma: no cover
    ...
    def _parse_token(
        self,
        token: Literal["W"],
        value: tuple[_WEEKDATE_ELEMENT, _WEEKDATE_ELEMENT, _WEEKDATE_ELEMENT | None],
        parts: _Parts,
    ) -> None:
        ...  # pragma: no cover
    ...
    def _build_datetime(parts: _Parts) -> datetime:
        ...
        day_of_week: int | None = parts.get("day_of_week")
        day = parts.get("day")
    ...
    def _generate_choice_re(
        choices: Iterable[str], flags: int | re.RegexFlag = 0
    ) -> Pattern[str]:
