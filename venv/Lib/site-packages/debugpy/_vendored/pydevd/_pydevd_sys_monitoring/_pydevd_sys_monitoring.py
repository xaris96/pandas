...
# ELSE
def _get_bootstrap_frame(depth: int) -> tuple[FrameType | None, bool]:
# ENDIF
# fmt: on
    try:
...
# ELSE
def _get_unhandled_exception_frame(exc, depth: int) -> FrameType | None:
# ENDIF
# fmt: on
    try:
...
# fmt: on
    def __init__(self):
        ...
        self.try_except_container_obj: _TryExceptContainerObj | None = None
...
# ELSE
def _get_thread_info(create: bool, depth: int) -> ThreadInfo | None:
# ENDIF
# fmt: on
    """
...
# fmt: on
    ...
    try:
        ...
        if frame is None:
            ...
            assert frame.f_code is code_obj, "{} != {}".format(frame.f_code, code_obj)
...
# ELSE
def enable_code_tracing(thread_ident: int | None, code, frame) -> bool:
# ENDIF
# fmt: on
    """
...
def update_monitor_events(suspend_requested: bool | None=None) -> None:
    """
