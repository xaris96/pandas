...
def handle_process_output(
    ...
    stderr_handler: None | Callable[[AnyStr], None] | Callable[[list[AnyStr]], None],
    ...
    class AutoInterrupt:
        ...
        def wait(self, stderr: None | str | bytes = b"") -> int:
            ...
            if status != 0:
                ...
                _logger.debug("AutoInterrupt wait stderr: {!r}".format(errstr))
    ...
    def transform_kwarg(self, name: str, value: Any, split_single_char_options: bool) -> list[str]:
        if len(name) == 1:
            ...
            if value is True:
                ...
                return ["--{}={}".format(dashify(name), value)]
        return []
    ...
    def _parse_object_header(self, header_line: str) -> tuple[str, str, int]:
        ...
        if len(tokens) != 3:
            if not tokens:
                ...
                raise ValueError("SHA {} could not be resolved, git returned: {!r}".format(tokens[0], header_line.strip()))
