...
class GitConfigParser(cp.RawConfigParser, metaclass=MetaParserBuilder):
    ...
    def _read(self, fp: BufferedReader | IO[bytes], fpname: str) -> None:
    ...
    def _has_includes(self) -> bool | int:
    ...
    def read(self) -> None:  # type: ignore[override]
        ...
        files_to_read: list[PathLike | IO] = [""]
        if isinstance(self._file_or_files, (str, os.PathLike)):
    ...
    def _write(self, fp: IO) -> None:
        ...
        def write_section(name: str, section_dict: _OMD) -> None:
            ...
            for key, values in section_dict.items_all():
                ...
                for v in values:
                    fp.write(("\t{} = {}\n".format(key, self._value_to_string(v).replace("\n", "\n\t"))).encode(defenc))
    ...
    def _assure_writable(self, method_name: str) -> None:
        if self.read_only:
            raise OSError("Cannot execute non-constant method {}.{}".format(self, method_name))
    ...
    def _string_to_value(self, valuestr: str) -> int | float | str | bool:
        types = (int, float)
    ...
    def _value_to_string(self, value: str | bytes | int | float | bool) -> str:
