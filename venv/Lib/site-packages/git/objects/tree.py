...
class Tree(IndexObject, git_diff.Diffable, util.Traversable, util.Serializable):
    ...
    * You may likewise access by index, like ``blob = tree[0]``.
    ...
    def _iter_convert_to_object(self, iterable: Iterable[TreeCacheTup]) -> Iterator[IndexObjUnion]:
        ...
        for binsha, mode, name in iterable:
            ...
            try:
                ...
                raise TypeError("Unknown mode {:o} found in tree data for path '{}'".format(mode, path)) from e
        # END for each item
    ...
    def traverse(
        self,
        predicate: Callable[[IndexObjUnion | TraversedTreeTup, int], bool] = lambda i, d: True,
        prune: Callable[[IndexObjUnion | TraversedTreeTup, int], bool] = lambda i, d: False,
        depth: int = -1,
