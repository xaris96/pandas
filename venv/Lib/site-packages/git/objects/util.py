...
def mode_str_to_int(modestr: bytes | str) -> int:
...
) -> type["Commit"] | type["TagObject"] | type["Tree"] | type["Blob"]:
...
class TraversableIterableObj(IterableObj, Traversable):
    ...
    def traverse(
        self: T_TIobj,
        predicate: Callable[[T_TIobj | tuple[T_TIobj | None, T_TIobj], int], bool],
        prune: Callable[[T_TIobj | tuple[T_TIobj | None, T_TIobj], int], bool],
        depth: int,
        branch_first: bool,
        visit_once: bool,
    ...
    ) -> Iterator[tuple[T_TIobj | None, T_TIobj]]: ...

    @overload
    def traverse(
        self: T_TIobj,
        predicate: Callable[[T_TIobj | TIobj_tuple, int], bool],
        prune: Callable[[T_TIobj | TIobj_tuple, int], bool],
        depth: int,
        branch_first: bool,
        visit_once: bool,
        ignore_self: Literal[True],
    ...
    def traverse(
        self: T_TIobj,
        predicate: Callable[[T_TIobj | TIobj_tuple, int], bool] = lambda i, d: True,
        prune: Callable[[T_TIobj | TIobj_tuple, int], bool] = lambda i, d: False,
        depth: int = -1,
        branch_first: bool = True,
        visit_once: bool = True,
        ignore_self: int = 1,
