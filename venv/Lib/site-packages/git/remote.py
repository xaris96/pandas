...
class PushInfo(IterableObj):
    ...
    def remote_ref(self) -> RemoteReference | TagReference:
        ...
        if self.remote_ref_string.startswith("refs/tags"):
            ...
            return RemoteReference(
                self._remote.repo,
                "refs/remotes/{}/{}".format(str(self._remote), remote_ref.name),
            )
        else:
    ...
    def _from_line(cls, remote: "Remote", line: str) -> "PushInfo":
        ...
        try:
            ...
            raise ValueError("Control character {!r} unknown as parsed from line {!r}".format(control_character, line)) from e
...
class Remote(LazyMixin, IterableObj):
    ...
    def __repr__(self) -> str:
        return '<git.{} "{}">'.format(self.__class__.__name__, self.name)
    ...
    def stale_refs(self) -> IterableList[Reference]:
        ...
        for line in self.repo.git.remote("prune", "--dry-run", self).splitlines()[2:]:
            ...
            if ref_name.startswith(Reference._common_path_default + "/"):
                ...
                fqhn = "{}/{}".format(RemoteReference._common_path_default, ref_name)
