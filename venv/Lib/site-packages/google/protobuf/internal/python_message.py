...
from google.protobuf.internal import (
    ...
    enum_type_wrapper,
    extension_dict,
    message_listener as message_listener_mod,
    type_checkers,
    well_known_types,
    wire_format,
)
...
def _ReraiseTypeErrorWithFieldName(message_name, field_name):
  ...
  if len(exc.args) == 1 and type(exc) is TypeError:
    ...
    exc = TypeError('{} for field {}.{}'.format(str(exc), message_name, field_name))
    ...
    for field_name, field_value in kwargs.items():
      ...
      if field.label == _FieldDescriptor.LABEL_REPEATED:
        ...
        if isinstance(field_value, message_mod.Message):
          ...
          raise TypeError(
              'Message field {}.{} must be initialized with a '
              'dict or instance of same class, got {}.'.format(
