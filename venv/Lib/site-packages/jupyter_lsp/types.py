...
LanguageServerSpec = dict[str, Any]
LanguageServerMessage = dict[str, Any]
KeyedLanguageServerSpecs = dict[str, LanguageServerSpec]
...
class MessageListener:
    ...
    language_server: Pattern[str] | None = None
    method: Pattern[str] | None = None
    ...
    def wants(self, message: LanguageServerMessage, language_server: str):
...
class HasListeners:
    ...
    async def wait_for_listeners(
        self, scope: MessageScope, message_str: str, language_server: str
    ) -> None:
