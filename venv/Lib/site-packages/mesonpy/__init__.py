...
class _WheelBuilder():
    ...
    def __init__(
        self,
        project: Project,
        metadata: pyproject_metadata.StandardMetadata | None,
    ...
    def _is_native(self, file: str | pathlib.Path) -> bool:
    ...
    def build_editable(self, directory: Path, verbose: bool = False) -> pathlib.Path:
        ...
        with mesonpy._wheelfile.WheelFile(wheel_file, 'w') as whl:
            ...
            whl.writestr(
                ...
                f'import {loader_module_name}'.encode())
...
class Project():
    ...
    def __init__(
        ...
        meson_args: MesonArgs | None = None,
    ...
    @property
    def license_file(self) -> pathlib.Path | None:
        if self._metadata:
...
@contextlib.contextmanager
def _project(config_settings: dict[Any, Any] | None) -> Iterator[Project]:
...
def _env_ninja_command(*, version: str = _NINJA_REQUIRED_VERSION) -> str | None:
