...
class Markdown:
    ...
    def __init__(
        ...
        self.after_render_hooks: list[
            Callable[["Markdown", str | list[dict[str, Any]], BlockState], str | list[dict[str, Any]]]
        ] = []
    ...
    def parse(self, s: str, state: BlockState | None = None) -> tuple[str | list[dict[str, Any]], BlockState]:
