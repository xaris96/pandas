...
def parse_strikethrough(inline: "InlineParser", m: Match[str], state: "InlineState") -> int | None:
...
def parse_mark(inline: "InlineParser", m: Match[str], state: "InlineState") -> int | None:
...
def parse_insert(inline: "InlineParser", m: Match[str], state: "InlineState") -> int | None:
