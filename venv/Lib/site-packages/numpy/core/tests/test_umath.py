...
class TestDivision:
    ...
    def test_floor_division_corner_cases(self, dtype):
        ...
        with suppress_warnings() as sup:
            ...
            assert(np.isnan(div)), "dt: {}, div: {}".format(dt, div)
...
def assert_arctan2_isnan(x, y):
    assert_(np.isnan(ncu.arctan2(x, y)), "arctan({}, {}) is {}, not nan".format(x, y, ncu.arctan2(x, y)))


def assert_arctan2_ispinf(x, y):
    assert_((np.isinf(ncu.arctan2(x, y)) and ncu.arctan2(x, y) > 0), "arctan({}, {}) is {}, not +inf".format(x, y, ncu.arctan2(x, y)))
...
def assert_arctan2_ispzero(x, y):
    assert_((ncu.arctan2(x, y) == 0 and not np.signbit(ncu.arctan2(x, y))), "arctan({}, {}) is {}, not +0".format(x, y, ncu.arctan2(x, y)))


def assert_arctan2_isnzero(x, y):
    assert_((ncu.arctan2(x, y) == 0 and np.signbit(ncu.arctan2(x, y))), "arctan({}, {}) is {}, not -0".format(x, y, ncu.arctan2(x, y)))
