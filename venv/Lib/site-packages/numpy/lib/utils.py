...
def who(vardict=None):
    ...
    for val in sta:
        print("{} {} {} {} {} {} {}".format(val[0], ' '*(sp1-len(val[0])+4),
    ...
    while stack:
        ...
        if inspect.ismodule(item):
                    ...
                    for mod_path in os.listdir(pth):
                        ...
                        try:
                            ...
                            try:
                                sys.stdout = StringIO()
                                sys.stderr = StringIO()
                                __import__("{}.{}".format(name, to_import))
                            finally:
            ...
            for n, v in _getmembers(item):
                try:
                    item_name = getattr(v, '__name__', "{}.{}".format(name, n))
                    mod_name = getattr(v, '__module__', None)
                except NameError:
                    # ref. SWIG's global cvars
                    #    NameError: Unknown C global variable
                    item_name = "{}.{}".format(name, n)
                    mod_name = None
                if '.' not in item_name and mod_name:
                    item_name = "{}.{}".format(mod_name, item_name)
