...
from parso.pgen2.grammar_parser import (
    GrammarParser,
    NFAState,
)
...
class DFAPlan:
    ...
    def __repr__(self):
        return '{}({}, {})'.format(self.__class__.__name__, self.next_dfa, self.dfa_pushes)
...
class DFAState(Generic[_TokenTypeT]):
    ...
    def __init__(self, from_rule: str, nfa_set: set[NFAState], final: NFAState):
        ...
        self.transitions: Mapping[_TokenTypeT | ReservedString, DFAPlan] = {}
