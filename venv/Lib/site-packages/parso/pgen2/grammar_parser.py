...
class NFAArc:
    def __init__(self, next_: 'NFAState', nonterminal_or_string: str | None):
        self.next: NFAState = next_
        self.nonterminal_or_string: str | None = nonterminal_or_string

    def __repr__(self):
        return '<{}: {}>'.format(self.__class__.__name__, self.nonterminal_or_string)
...
class NFAState:
    ...
    def __repr__(self):
        return '<{}: from {}>'.format(self.__class__.__name__, self.from_rule)
