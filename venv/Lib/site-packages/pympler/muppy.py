...
def get_size(objects: list[Any]) -> int:
    ...
    for o in objects:
        try:
            ...
            print("IGNORING: type={}; o={}".format(str(type(o)), str(o)))
    return res
...
def filter(objects: list[Any], Type: type | None = None, min: int = -1,
           max: int = -1) -> list[Any]:
    """Filter objects.
...
def _get_usage(function: Callable, *args: Any) -> list | None:
