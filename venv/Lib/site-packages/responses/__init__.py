...
from responses.matchers import (
    json_params_matcher as _json_params_matcher,
    query_string_matcher as _query_string_matcher,
    urlencoded_params_matcher as _urlencoded_params_matcher,
)
...
def urlencoded_params_matcher(params: dict[str, str] | None) -> Callable[..., Any]:
    warn(
...
def json_params_matcher(params: dict[str, Any] | None) -> Callable[..., Any]:
    warn(
...
class CallList(Sequence[Any], Sized):
    ...
    def __getitem__(self, idx: int | slice) -> Call | list[Call]:
...
def _handle_body(
    body: bytes | BufferedReader | str | None
...
class BaseResponse:
    ...
    def __init__(
        ...
        method: str,
        url: "_URLPatternType",
        match_querystring: bool | object = None,
    ...
    def _should_match_querystring(
        self, match_querystring_argument: bool | object
    ) -> bool | object:
...
class RequestsMock:
    ...
    def __init__(
        ...
        *,
        ...
        self.response_callback: Callable[[Any], Response] | None = response_callback
    ...
    def add_callback(
        ...
        callback: Callable[
            ["PreparedRequest"],
            Exception | tuple[int, Mapping[str, str], "_Body"],
        ],
        match_querystring: bool | FalseBool = FalseBool(),
        content_type: str | None = "text/plain",
        match: "_MatcherIterable" = (),
    ) -> None:
        self._registry.add(
    ...
    def _read_filelike_body(
        self, body: str | bytes | BufferedReader | None
    ) -> str | bytes | None:
