...
def empty_like(
    x: ndarray, /, xp, *, dtype: Dtype | None = None, device: Device | None = None,
    **kwargs
) -> ndarray:
    _check_device(xp, device)
...
def std(
    ...
    *,
    ...
    correction: int | float = 0.0, # correction instead of ddof
    keepdims: bool = False,
    **kwargs,
) -> ndarray:
...
def isdtype(
    dtype: Dtype, kind: Dtype | str | tuple[Dtype | str, ...], xp,
