...
def matrix_norm(x: ndarray, /, xp, *, keepdims: bool = False, ord: int | float | Literal['fro', 'nuc'] | None = 'fro') -> ndarray:
...
def vector_norm(x: ndarray, /, xp, *, axis: int | tuple[int, ...] | None = None, keepdims: bool = False, ord: int | float | None = 2) -> ndarray:
