...
class Query(
    ...
    @property
    def statement(self) -> Select[_T] | FromStatement[_T] | UpdateBase:
        ...
        stmt: Select[_T] | FromStatement[_T] | UpdateBase
    ...
    @property
    def selectable(self) -> Select[_T] | FromStatement[_T] | UpdateBase:
    ...
    def __clause_element__(
        self,
    ) -> Select[_T] | FromStatement[_T] | UpdateBase:
        return (
    ...
    def delete(
        ...
        delete_args: dict[Any, Any] | None = None,
    ) -> int:
...
class BulkDelete(BulkUD):
    ...
    def __init__(
        self,
        query: Query[Any],
        delete_kwargs: dict[Any, Any] | None,
    ):
        super().__init__(query)
