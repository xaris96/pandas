...
class SQLCompiler(Compiled):
    ...
    def visit_scalar_function_column(self, element, **kw):
        ...
        return "({}).{}".format(compiled_fn, compiled_col)
...
class GenericTypeCompiler(TypeCompiler):
    ...
    def visit_NUMERIC(self, type_: sqltypes.Numeric[Any], **kw: Any) -> str:
        if type_.precision is None:
            ...
            return "NUMERIC({precision})".format(precision=type_.precision)
        else:
...
class IdentifierPreparer:
    ...
    def format_constraint(
        self, constraint: Constraint | Index, _alembic_quote: bool = True
    ) -> str | None:
