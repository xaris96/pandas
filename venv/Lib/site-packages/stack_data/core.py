...
def markers_from_ranges(
        ...
        converter: Callable[[RangeInLine], tuple[str, str] | None],
) -> list[MarkerInLine]:
    """
...
class RepeatedFrames:
    ...
    def __init__(
            self,
            frames: list[FrameType | TracebackType],
...
class FrameInfo:
    ...
    def __init__(
            self,
            frame_or_tb: FrameType | TracebackType,
    ...
    @cached_property
    def _pygmented_scope_lines(self) -> tuple[int, list[str]] | None:
